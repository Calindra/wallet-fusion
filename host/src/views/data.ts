...
const Shopitems = [
  {
    ...
    price: '$12',
    colors: [(theme: any) => theme.palette.secondary.main, (theme: any) => theme.palette.primary.main],
    photo: s1,
    id: 1,
    star: [1, 2, 3, 4, 5],
  },
  {
    ...
    price: '$30',
    colors: [(theme: any) => theme.palette.success.main, (theme: any) => theme.palette.secondary.main],
    photo: s2,
    id: 2,
    star: [1, 2, 3, 4],
  },
  {
    ...
    category: 'Toy shop',
    price: '$10',
    colors: [(theme:any) => theme.palette.primary.main, (theme:any) => theme.palette.secondary.main],
    photo: s3,
    id: 3,
    star: [1, 2, 3],
  },
  {
    ...
    category: 'AtoZ shop',
    price: '$250',
    colors: [(theme:any) => theme.palette.error.main, (theme:any) => theme.palette.warning.main],
    photo: s4,
    id: 4,
    star: [1, 2, 3, 4, 5],
  },
